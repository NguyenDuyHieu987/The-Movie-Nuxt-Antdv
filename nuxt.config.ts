...
export default defineNuxtConfig({
  ...
  routeRules: {
    '/': { swr: 10, prerender: true, static: true },
    '/search/**': { swr: 10, prerender: true, static: true },
    '/discover/**': { ssr: false, swr: 10, prerender: true, static: true },
    '/follow/**': { swr: 10, prerender: true },
    '/history/**': { swr: 10, prerender: true },
    '/ranking/**': { swr: 10, prerender: true, static: true },
    '/info-movie/**': { ssr: false, swr: 10, prerender: true, static: true },
    '/info-tv/**': { ssr: false, swr: 10, prerender: true, static: true },
    '/play-movie/**': { ssr: false, swr: 10, prerender: true, static: true },
    '/play-tv/**': { ssr: false, swr: 10, prerender: true, static: true },
    '/oauth': { swr: 10, prerender: true, static: true },
    '/login': { swr: 10, prerender: true },
    '/signup': { swr: 10, prerender: true },
    '/upgrade/plans': { swr: 10, prerender: true, static: true },
    '/upgrade/payment': {
      ssr: false,
      swr: 10,
      prerender: true,
