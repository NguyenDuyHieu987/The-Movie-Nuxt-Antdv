...
export default defineNuxtConfig({
  ...
  routeRules: {
    ...
    '/search/**': { static: true, swr: true },
    '/discover/**': { static: true, swr: true },
    '/list/**': { static: true, swr: true },
    '/history/**': { static: true, swr: true },
    '/ranking/**': { static: true, swr: true },
    '/info/**': { static: true, swr: true },
    '/play/**': { static: true, swr: true },
  },
});
