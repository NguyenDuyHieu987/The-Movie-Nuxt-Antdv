...
export default defineNuxtConfig({
  ...
  routeRules: {
    ...
    '/search/**': { static: true, ssr: true },
    '/discover/**': { static: true, ssr: true },
    '/list/**': { static: true, ssr: true },
    '/history/**': { static: true, ssr: true },
    '/ranking/**': { static: true, ssr: true },
    '/info/**': { static: true, ssr: true },
    '/play/**': { static: true, ssr: true },
  },
});
