...
export default defineNuxtConfig({
  ...
  routeRules: {
    ...
    '/search/**': { swr: 10, prerender: true },
    '/discover/**': { ssr: false, swr: 10, prerender: true },
    '/follow/**': { swr: 10, prerender: true },
    '/history/**': { swr: 10, prerender: true },
    '/ranking/**': { swr: 10, prerender: true },
    '/info-movie/**': { ssr: false, swr: 10, prerender: true },
    '/info-tv/**': { ssr: false, swr: 10, prerender: true },
    '/play-movie/**': { ssr: false, swr: 10, prerender: true },
    '/play-tv/**': { ssr: false, swr: 10, prerender: true },
