  ...
  <div class="like-share">
    ...
    >
      <template #header>
        ...
        <CloseBtn class="transparent" @click="openModal = false" />
      </template>
      ...
      <div class="list-network">
        ...
        >
          <a-button class="click-active" type="primary">
            <template #icon>
              <svg
                class="fa-facebook-f"
                xmlns="http://www.w3.org/2000/svg"
...
const props = withDefaults(defineProps<{ class: string; dataMovie: any }>(), {
  class: '',
});
