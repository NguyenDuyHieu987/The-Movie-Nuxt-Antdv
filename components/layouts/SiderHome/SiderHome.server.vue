...
onMounted(() => {
  ...
  const menu: HTMLElement | null = document.querySelector(
    '.sider-home .ant-layout-sider-children .menu-sider-bar'
  );
  const sider_header = document.querySelector(
    '.sider-home .sider-header'
  ) as HTMLElement;
  ...
  const siderBar = document.querySelector('.sider-home');
...
<style lang="scss" src="./SiderHome.scss"></style>
