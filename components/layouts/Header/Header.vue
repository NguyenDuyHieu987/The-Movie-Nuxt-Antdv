<template>
  <header class="header-bar">
    ...
    <div class="right-header">
      ...
      >
        <el-menu-item class="notification" index="notification">
          <a-dropdown
            v-if="isLogin"
            :trigger="['click']"
        ...
        <el-sub-menu class="account" index="account">
          <template #title>
            <svg
              class="user-outlined"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <el-menu-item v-if="isLogin && role == 'admin'" index="dashboard">
          ...
          <el-menu-item v-if="isLogin" index="logout" @click="handleLogout">
            <span> Đăng xuất</span>
          </el-menu-item>
        </el-sub-menu>
      </el-menu>
